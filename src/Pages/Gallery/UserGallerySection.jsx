    ...
    <div className="container mx-auto p-4">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {events.map((event, index) => (
          <div
            key={index}
            className="gallery-item relative group" // Renamed class for clarity
          >
            <img
              src={event.Images}
              alt={event["Event Title"]}
              className="w-full h-64 object-cover transition-transform duration-300 hover:scale-105" // Added hover effect
            />
